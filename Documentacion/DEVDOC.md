...
* **sprinkleSetter** → _Relé időzítése manuálisan_:
* **chainSprinkler** → _Sorban locsolás_:
* **testSprinkler** → _Tesztelés_:
* **settings** → _Beállítások_:
* **clockSetter** → _Óra beállítása_:
* **developer** → _Fejlesztői beállítások_:
